...
public class BarraHerramientasIIProcesadorTexto {
...
class Marco extends JFrame {
  public Marco() {
    setTitle("video112 BarraHerramientasIIProcesadorTexto");
...
class LaminaProcesador extends JPanel {
  ...
  private void BD_Left() {

    barra = new JToolBar();

    configuraBarra("bin/graficos/imagenes/rojo.png").addActionListener(new StyledEditorKit.BoldAction());
    configuraBarra("bin/graficos/imagenes/amarillo.png").addActionListener(new StyledEditorKit.ItalicAction());
    configuraBarra("bin/graficos/imagenes/azul.png").addActionListener(new StyledEditorKit.UnderlineAction());

    barra.addSeparator();

    configuraBarra("bin/graficos/imagenes/azul.png") .addActionListener(new StyledEditorKit.ForegroundAction("azul", Color.BLUE));
    configuraBarra("bin/graficos/imagenes/rojo.png") .addActionListener(new StyledEditorKit.ForegroundAction("rojo", Color.RED));
    configuraBarra("bin/graficos/imagenes/amarillo.png") .addActionListener(new StyledEditorKit.ForegroundAction("amarillo", Color.YELLOW));

    barra.addSeparator();

    configuraBarra("bin/graficos/imagenes/azul.png") .addActionListener(new StyledEditorKit.AlignmentAction("izquierda", 0));
    configuraBarra("bin/graficos/imagenes/azul.png") .addActionListener(new StyledEditorKit.AlignmentAction("derecha", 2));
    configuraBarra("bin/graficos/imagenes/azul.png") .addActionListener(new StyledEditorKit.AlignmentAction("centrado", 1));
    configuraBarra("bin/graficos/imagenes/azul.png") .addActionListener(new StyledEditorKit.AlignmentAction("justificado", 3));
  ...
  private JButton negrita_barra, cursiva_barra, subraya_barra, azul_barra, rojo_barra, amarillo_barra, a_izquierda,
      a_derecha, a_centrado, a_justificado;
