...
class Marco extends JFrame {
  public Marco() {
    setTitle("StyledEditorKit ProcesadorTexto II");
...
class LaminaProcesador extends JPanel {
  ...
  private void agregarIconoMenu(JMenuItem elem_menu) {
    String rotulo = elem_menu.getText();
    ...
    switch (rotulo) {
      case "Negrita":
        ...
        break;
      case "Cursiva":
        elem_menu.setIcon(new ImageIcon("bin/graficos/imagenes/azul.png"));
